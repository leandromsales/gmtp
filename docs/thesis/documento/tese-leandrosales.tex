\documentclass[letterpaper,titlepage]{copin}
...
\Titulo{Distribuição de Mídias ao Vivo através de uma Rede de Favores Constituída entre Roteadores} % pela Intersecção e Seleção de Rotas Comuns}
