 ...
 */
#ifndef _GMTP_CCID3_H_
#define _GMTP_CCID3_H_
...
{
	struct ccid3_hc_tx_sock *hctx = ccid_priv(gmtp_sk(sk)->gmtps_hc_tx_ccid);
	BUG_ON(hctx == NULL);
	return hctx;
}
...
{
	struct ccid3_hc_rx_sock *hcrx = ccid_priv(gmtp_sk(sk)->gmtps_hc_rx_ccid);
	BUG_ON(hcrx == NULL);
	return hcrx;
}

#endif /* _GMTP_CCID3_H_ */
