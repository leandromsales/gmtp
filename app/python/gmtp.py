...
socket.GMTP_SOCKOPT_GET_CUR_MSS = 3
socket.GMTP_SOCKOPT_SERVER_RTT = 4
socket.GMTP_SOCKOPT_SERVER_TIMEWAIT = 5
socket.GMTP_SOCKOPT_PULL = 6
socket.GMTP_SOCKOPT_ROLE_RELAY = 7
socket.GMTP_SOCKOPT_RELAY_ENABLED = 8
