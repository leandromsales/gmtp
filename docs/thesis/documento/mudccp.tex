...
\section{Outras funções no GMTP}
...
segurança, implementação e implantação.
...
\pac{\mudccp-Close} pelo canal de controle, contendo o nome do fluxo que deseja
se desconectar. Ao receber este tipo de pacote, o nó \repasss transmite ao nó
\clis um pacote do tipo \pac{\mudccp-Reset}, sinalizando que está ciente do
...
\pac{\mudccp-Request}, no pacote de resposta \pac{\mudccp-Response}, o nó
...
\pac{\mudccp-Close}, este deve verificar se o referido nó \clis é um nó \rel. Em
...
\pac{\mudccp-Elect} e aguardar por um \mudccp-ElectReply. Este procedimento
...
mal-intencionados poluam o sistema com conteúdos alterados
(Figura~\ref{fig:bucket-brigade-principle-4}. Isto porque um nó \repasss ao
processar um pacote do tipo \pks $\in$ \setpks pode injetar um conteúdo
multimídia diferente do originalmente transmitido pelo nó \serv, comprometendo
o sistema.
