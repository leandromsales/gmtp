...
GST_BOILERPLATE (GstGMTPServerSink, gst_gmtp_server_sink, GstBaseSink,
    GST_TYPE_BASE_SINK);
...
gst_gmtp_server_sink_init (GstGMTPServerSink * this,
    GstGMTPServerSinkClass * g_class)
{
...
static void
gst_gmtp_server_sink_base_init (gpointer g_class)
{
  ...
  gst_element_class_set_static_metadata (element_class, "GMTP server sink",
      "Sink/Network",
