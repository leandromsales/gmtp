...
static inline int ccid_get_current_rx_ccid(struct gmtp_sock *dp)
{
	struct ccid *ccid = dp->gmtps_hc_rx_ccid;
...
static inline int ccid_get_current_tx_ccid(struct gmtp_sock *dp)
{
	struct ccid *ccid = dp->gmtps_hc_tx_ccid;
 ...
 * - autonomous dequeueing (CCID internally schedules gmtps_xmitlet).
 */
