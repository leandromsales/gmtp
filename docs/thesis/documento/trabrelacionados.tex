...
\end{center}
\vspace{-0.5cm}
\caption{Organização dos nós PDTP. Adaptada de~\cite{arcieri2004}.}
\label{fig:arq-pdtp}
\end{figure}
...
Multicast}). Figura extraída de~\cite{5061910}.}
\label{fig:arq-cpm}
\end{figure}
