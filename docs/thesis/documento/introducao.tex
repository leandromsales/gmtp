...
A Internet é um sucesso tecnológico e sua infra-estrutura global conecta bilhões de hospedeiros, transmitindo-se uma volumosa quantidade de dados digitais diariamente. A proposta inicial foi de interconectar hospedeiros para compartilhar recursos computacionais antes escassos, enquanto atualmente (2014) serve para recuperar diferentes tipos de conteúdos, proporcionando-se uma grande revolução com relação aos métodos de transmissão de mídias ao vivo (áudio e/ou vídeo).
