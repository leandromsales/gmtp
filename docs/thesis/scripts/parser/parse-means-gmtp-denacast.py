...
if opt == "1" or not opt: #generate
    ...
    file_tratamentos_gmtp = open("gmtp-denacast/gmtp-tratamento.txt", 'w')
    file_tratamentos_denacast = open("gmtp-denacast/denacast-tratamento.txt", 'w')
    ...
    for tratamento in range(0, len(tratamentos_array)):
        ...
        filename = "gmtp-denacast/gmtp-tratamento-%d-ensaios.txt" % (tratamento+1)
        file_ensaios_gmtp = open(filename, 'w')
        filename = "gmtp-denacast/denacast-tratamento-%d-ensaios.txt" % (tratamento+1)
...
#            print startup_delay_denacast, "\t", cont_index_denacast, "\t", distortion_denacast, "\t", server_conn_denacast, "\t", client_conn_denacast, "\t", ctrl_packets_denacast, "\t"
        ...
        startup_delay_denacast_ci = "(%.2f - %.2f)" % (startup_delay_denacast_mean - delta, startup_delay_denacast_mean + delta) 
        ...
        cont_index_denacast_ci = "(%.2f - %.2f)" % (cont_index_denacast_mean - delta, cont_index_denacast_mean + delta) 
        ...
        distortion_denacast_ci = "(%.2f - %.2f)" % (distortion_denacast_mean - delta, distortion_denacast_mean + delta) 
        ...
        server_conn_denacast_ci = "(%.2f - %.2f)" % (server_conn_denacast_mean - delta, server_conn_denacast_mean + delta) 
        ...
        server_conn_denacast_ci = "(%.2f - %.2f)" % (server_conn_denacast_mean - delta, server_conn_denacast_mean + delta) 
        client_conn_denacast_ci = "(%.2f - %.2f)" % (client_conn_denacast_mean - delta, client_conn_denacast_mean + delta) 
        ...
        ctrl_packets_denacast_ci = "(%.2f - %.2f)" % (ctrl_packets_denacast_mean - delta, ctrl_packets_denacast_mean + delta)
        ...
        file_tratamentos_denacast.write("%.2f\t%.2f\t%.2f\t%.2f\t%.2f\t%.2f\t%d\n" % (startup_delay_denacast_mean, cont_index_denacast_mean, distortion_denacast_mean, server_conn_denacast_mean, client_conn_denacast_mean, ctrl_packets_denacast_mean, total_repeticoes))
