...
lista de possíveis nós repassadores parceiros;
  ...
  \item \pac{GMTP-Data:} qualquer nó utiliza esse tipo de pacote para
transmitir dados da
aplicação;
...
% No Apêndice~\ref{app:mudccp-tecnica}, apresenta-se detalhes acerca do uso dos tipos de pacotes do GMTP, sendo seu teor bastante técnico e portanto dedicado aos leitores interessados em sua implementação.
...
\repass, vindo diretamente do nó \servs ou repassado por outros nós
...
No Algoritmo~\ref{algo:registerRelay}, executado por um nó \repass, resume-se os
passos para o envio do pedido de registro de participação em um nó \serv. Note
que não é requerido que o nó \repasss informe qual fluxo de dados \setpks está
interessado em obter. Se \setpks for especificado, o nó \servs executará um procedimento para determinar se aceita ou não o pedido de registro de participação e logo começar a transmitir \setpks a \repass. Em caso de aceite, inicia-se a transmissão de \setpks a partir de \servs em direção \repasss em modo unicast. Caso contrário, o nó \servs, com base nos caminhos \setwayis conhecidos, instruirá um outro nó \repassu{q} a transmitir o referido fluxo de dados ao nó \repasss solicitante, tal como detalhou-se anteriormente. Já no Algoritmo~\ref{algo:onReceiveGMTPRegisterReply}, resume-se os passos após um nó
\repasss receber uma resposta do tipo \pac{GMTP-Register-Reply}, transmitida pelo
nó \serv, referente ao pedido de registro de participação transmitido anteriormente por \repass. Note que \repasss transmite de volta a \servs o caminho \setwayi.
...
indiretamente, por meio da interceptação de registros de participação. A propósito, em ICN isso não é possível.
