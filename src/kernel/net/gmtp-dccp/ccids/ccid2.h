 ...
 */
#ifndef _GMTP_CCID2_H_
#define _GMTP_CCID2_H_
...
{
	return ccid_priv(gmtp_sk(sk)->gmtps_hc_tx_ccid);
}

static inline struct ccid2_hc_rx_sock *ccid2_hc_rx_sk(const struct sock *sk)
{
	return ccid_priv(gmtp_sk(sk)->gmtps_hc_rx_ccid);
}
#endif /* _GMTP_CCID2_H_ */
