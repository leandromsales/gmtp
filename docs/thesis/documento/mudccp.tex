...
Quando um nó cliete deseja reproduzir um determinado evento, este envia uma
...
é que um nó repassador pode interceptar tal requisio durante seu trajeto até o
...
que o pedido de conexão é intencionamente endereço ao nó servidor que transmite
...
\subsection{Resumo das principais funções}
...
pode-se antecipar a formação de parcerias pre-selecionando nós \repasss em
...
antecipadamente e selecionar um subconjunto de possíveis nós parcerios
...
CDN, porém di âmicos, que podem ser acionados quando conveniente.
...
\subsection{Habilitar / desabilitar validação dos pacotes \pks $\in$ \setpk}
