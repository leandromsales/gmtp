...
GST_BOILERPLATE (GstGMTPClientSrc, gst_gmtp_client_src, GstPushSrc,
    GST_TYPE_PUSH_SRC);
...
static void
gst_gmtp_client_src_base_init (gpointer g_class)
{
  ...
  gst_element_class_set_static_metadata (element_class, "GMTP client source",
      "Source/Network",
