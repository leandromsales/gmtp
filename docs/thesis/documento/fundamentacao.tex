...
Os nós têm um armazenamento local, onde guardam os dados do vídeo para uma execução contínua. Estes nós devem verificar quais partes de dados são necessários, havendo maneiras apropriadas de seleciona-los e requisitá-los. Para isso, apresentou-se duas abordagens denominadas \aspas{Gulosa} e \aspas{Mais Raro Primeiro}. Essas estratégias mantém o fluxo da execução sem interrupções e dissemina o conteúdo rapidamente pela rede P2P, respectivamente.
