...
\subsection{Redes de Centradas no Conteúdo (CCN)}
\label{subsec:ndn}
...
Hence, in CCN, CS acts as a cache, while interests are
forwarded according to FIB information and data is forwarded
according to PIT information. As interest packets and data
chunks travel across CCN nodes, multiple lookups in several
data structures have to be performed.
