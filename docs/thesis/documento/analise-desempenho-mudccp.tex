...
O objetivo do experimento foi avaliar o desempenho do GMTP com vista à hipótese enunciada de que a constituição de uma rede de favores entre roteadores que interceptam, realizam \textit{cache} temporário e compartilham pacotes de dados tanto em modo \textit{multicast} quanto em modo \textit{unicast}, auxiliados por nós servidores para determinar as parcerias com base em um algoritmo para controle de congestionamento assistido pela rede, resulta na distribuição mais eficiente de mídias ao vivo.
...
%     \textbf{Média aritmética} & \multicolumn{4}{c}{\ut{83,36}{\%}} & \multicolumn{4}{c}{\ut{58,17}{\%}} \\
    \textbf{Média ponderada (Pesos: 2, 3, 3, 1)} & \multicolumn{4}{c}{\ut{61,44}{\%}} & \multicolumn{4}{c}{\ut{35,95}{\%}} \\
    \bottomrule
  \end{tabular}
...
Neste contexto, na Tabela~\ref{tb:sumario-resultados}, sumarizam-se os ganhos do GMTP sobre o Denacast e o CCN-TV, discutidos ao longo deste capítulo. Considerando-se as discussões apresentadas para cada uma das métricas estudadas, com base em simulação de um cenário real de rede, pode-se afirmar que ao utilizar o GMTP é possível melhorar o desempenho dos sistemas baseados nas principais técnicas de distribuição de mídias ao vivo adotadas no estado da prática em \ut{61,44}{\%}, ao passo que melhora-se em \ut{35,95}{\%} se comparado a proposta mais importante disponível no estado da arte para distribuição de conteúdos através da Internet. Para obter os referidos valores, calculou-se a média ponderada com pesos (2, 3, 3, 1) para as métricas atraso de inicialização, índice de continuidade, distorção e sobrecarga de controle, respectivamente.
