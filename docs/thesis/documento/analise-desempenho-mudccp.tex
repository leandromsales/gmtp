...
As different network delays influence the performance of the different protocols, we carry out these evaluations using different round trip times (RTT) ranging from 0 to 150ms~\cite{6607500}.

índice de continuidade e outros aqui
% http://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=4797218

http://named-data.net/techreport/TR005-ndnsim.pdf
http://pt.slideshare.net/PARCInc/ccnxcon2012-session-6-omnet-simulator
http://www.ccn-lite.net/
https://github.com/cn-uofbasel/ccn-lite/blob/master/README-OMNeT.txt
https://github.com/cn-uofbasel/ccn-lite
CCNSim:
% http://ieeexplore.ieee.org/xpl/articleDetails.jsp?tp=&arnumber=6654874
