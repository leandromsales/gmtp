...
#ifdef CONFIG_IP_GMTP_TFRC_DEBUG
extern bool tfrc_debug;
#define tfrc_pr_debug(format, a...)	GMTP_PR_DEBUG(tfrc_debug, format, ##a)
#else
...
static inline u32 scaled_div32(u64 a, u64 b)
{
	...
	if (result > UINT_MAX) {
		GMTP_CRIT("Overflow: %llu/%llu > UINT_MAX",
