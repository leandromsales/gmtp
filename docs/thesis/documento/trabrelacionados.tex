...
Neste capítulo, apresentou-se uma avaliação crítica acerca de um conjunto de protocolos e sistemas para distribuição de mídias ao vivo. Discutiu-se sobre propostas concorrentes ao \mudccp, entendendo-se que nenhuma contempla os recursos e métodos empregados no GMTP. De fato, a combinação das funções do GMTP e o foco no transporte de fluxos de dados de mídias ao vivo, faz do GMTP um protocolo inédito. Sendo assim, como ilustra-se na Figura~\ref{fig:gmtp-posicao}, pode-se afirmar que o GMTP é uma evolução significativa do estado da arte, posicionado entre as diversas soluções existentes para distribuição de mídias ao vivo e arquiteturas de rede para a Internet do futuro, ainda circundadas de muitas incertezas.
...
Nesse contexto, considera-se o CoolStreaming/Denacast e o CCN-TV as propostas mais próximas ao GMTP, principalmente pela última se tratar de uma nova vertente de pesquisa. Por esse motivo, no Capítulo~\ref{cap:analisedesemp}, discute-se em detalhes o desempenho de ambas as soluções em comparação ao GMTP.
