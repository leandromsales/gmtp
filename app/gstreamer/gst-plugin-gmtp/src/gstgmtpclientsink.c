...
GST_BOILERPLATE (GstGMTPClientSink, gst_gmtp_client_sink, GstBaseSink,
    GST_TYPE_BASE_SINK);
...
static void
gst_gmtp_client_sink_base_init (gpointer g_class)
{
  ...
  gst_element_class_set_static_metadata (element_class, "GMTP client sink",
      "Sink/Network",
...
gst_gmtp_client_sink_init (GstGMTPClientSink * this,
    GstGMTPClientSinkClass * g_class)
{
