...
Em modo de transmissão unicast, utilizado na comunicação entre os nós \repass, define-se a taxa de transmissão de um nó \mudccps através de uma versão modificada do protocolo RCP (Rate Control Protocol)~\cite{Dukkipati:2008:RCP:1368746}. Já em modo de transmissão
